...
export const BOTTOM_STRIP_HEADING = "Home gym staples worth stocking up";
export const BOTTOM_STRIP_SUBHEAD = "Fitness refills we track on GymLedger — partner links, no extra cost to you.";
